...
verification commands per change type, and the honest gaps (updated 2026-08-08).
...
## 5. Gaps — honest, as of 2026-08-08
...
- Re-verified 2026-08-08 from calculation/tariff/TFP/XML tests, smoke, package scripts, seeds, schema, and README.
